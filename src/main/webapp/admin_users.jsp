...
<body>
	<div class="container mt-5">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center"><a
						href="admin_users.jsp?action=view&userId=<%=rsAll.getInt("user_id")%>"
						class="btn btn-sm btn-info">View</a> <a
						href="admin_users.jsp?action=edit&userId=<%=rsAll.getInt("user_id")%>"
						class="btn btn-sm btn-warning">Edit</a> <a
						href="admin_users.jsp?action=delete&userId=<%=rsAll.getInt("user_id")%>"
		...
		<p>
			<strong>Email:</strong>
			<%=email%></p>
		<a href="admin_users.jsp" class="btn btn-secondary">Back to list</a>
		...
		<h3>Edit User</h3>
		<form method="post"
			action="admin_users.jsp?action=update&userId=<%=userId%>">
			<div class="mb-3">

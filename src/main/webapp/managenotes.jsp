...
<body>
	<div class="container mt-5">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center"><a
						href="managenotes.jsp?action=view&noteId=<%=rsAll.getInt("note_id")%>"
						class="btn btn-sm btn-info">View</a> <a
						href="managenotes.jsp?action=edit&noteId=<%=rsAll.getInt("note_id")%>"
						class="btn btn-sm btn-warning">Edit</a> <a
						href="managenotes.jsp?action=delete&noteId=<%=rsAll.getInt("note_id")%>"
		...
		<p>
			...
			<%=updatedAt%></p>
		<a href="managenotes.jsp" class="btn btn-secondary">Back to list</a>
		...
		<h3>Edit Note</h3>
		<form method="post"
			action="managenotes.jsp?action=update&noteId=<%=noteId%>">
			<div class="mb-3">
			...
			<a href="managenotes.jsp" class="btn btn-secondary">Cancel</a>
		</form>
		<%
		}
		%>
